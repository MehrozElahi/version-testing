...
" />
  ...
  <a class="right carousel-control" href="#myCarousel" role="button" data-slide="next">
   ...
   <br />  <br /> <br /> <br />  <br />  <br />  <br /> <br /> <br /> <br />  <br />  <br />  <br /> <br />   <br />  <br />  <br /> <br /> <br />  <br /> <br /> <hr style="color:brown" />
   


    <!-- Card   -->
    <div style="background-color:white">
     <div class="container annmi" >
         <div class="row">
    ...
    <div class="card card-cascade narrower">
        ...
        <!--Card image-->
        <div class="view overlay hm-white-slight"  onclick="window.location='Signup.aspx'" >
        ...
        <!--Card content-->
        <div class="card-block">
            <h5 class="red-text"><i class="fa fa-search" aria-hidden="true"></i> &nbsp <b>Search Doctor</b></h5>
            <!--Title-->
            
            <!--Text-->
            <p class="card-text" > &nbsp&nbsp&nbsp Find a Doctor</p>
            <a class="btn  "style="color:white;">Click here</a>
        </div>
        <!--/.Card content-->
